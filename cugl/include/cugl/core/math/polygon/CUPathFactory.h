...
#include <cugl/core/math/polygon/CUPolyEnums.h>
...
#pragma mark Rounded Shapes
    ...
    Path2 makeArc(const Vec2 center, float radius, float start, float degrees, bool closed) const {
        return makeArc(center.x,center.y,radius,start,degrees, closed);
    }
    ...
    Path2* makeArc(Path2* path, const Vec2 center, float radius, float start, float degrees, bool closed) const {
        return makeArc(path,center.x,center.y,radius,start,degrees, closed);
    }

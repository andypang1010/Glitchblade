...
void Boss2Model::attachNodes(const std::shared_ptr<AssetManager>& assetRef) {
    ...
    _laserVFXSprite->setPosition(1150 * 2 * 0.0004006410 * Application::get()->getDisplayWidth(), 0);
	_laserVFXSprite->setScale(2 * 0.0004006410 * Application::get()->getDisplayWidth());

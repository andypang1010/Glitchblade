#ifndef __GB_MINION2A_MODEL_H__
#define __GB_MINION2A_MODEL_H__
#include <cugl/cugl.h>
...
*/
class Minion2AModel : public EnemyModel {
private:
    /** This macro disables the copy constructor (not allowed on physics objects) */
    CU_DISALLOW_COPY_AND_ASSIGN(Minion2AModel);
protected:
...
#pragma mark Hidden Constructors
     ...
     */
    Minion2AModel() : EnemyModel(){}

    /**
     * Destroys this PlayerModel, releasing all resources.
     */
    virtual ~Minion2AModel(void) override { dispose(); }
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<Minion2AModel> alloc(const std::shared_ptr<AssetManager>& assetRef, const std::shared_ptr<JsonValue>& enemiesJSON, const Vec2& pos, std::vector<std::shared_ptr<ActionModel>> actions) {
        std::shared_ptr<Minion2AModel> result = std::make_shared<Minion2AModel>();
...
#pragma mark AI Methods
    ...
    /**
     * Checks if target is in range and angle for shooting attack
     *
     * @return the target player is in the correct range and angle
     */
    bool isInRange();

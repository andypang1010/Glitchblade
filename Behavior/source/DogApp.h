...
//  Version: 12/19/24
//
#ifndef __DOG_APP_H__
#define __DOG_APP_H__
#include <cugl/cugl.h>
#include "DogDemo.h"
 ...
 */
class DogApp : public cugl::Application {
protected:
  /** The global sprite batch for drawing (only want one of these) */
  std::shared_ptr<cugl::graphics::SpriteBatch> _batch;
  /** The global asset manager */
  std::shared_ptr<cugl::AssetManager> _assets;
  /** The primary controller for the dog demo */
  DogDemo _dogDemo;
...
public:
   ...
   */
  DogApp() : cugl::Application(), _loaded(false) {}
